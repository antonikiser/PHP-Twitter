        ...
        <div id="register" class="animate form ">
          <section class="login_content">
            <form action="do_register.php" method="post">
              ...
              <div>
                <input type="text" method "post" class="form-control" placeholder="Password" name="haslo_rejestracji" required="" />
              </div>
			  <div>
                <input type="text" method "post" class="form-control" placeholder="Password" name="haslo2_rejestracji" required="" />
              </div>
              <div>
                <input type="submit" value="Zarejestruj sie!" class="btn btn-default submit" >
              </div>
